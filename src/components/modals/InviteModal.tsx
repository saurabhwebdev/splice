      ...
      <div className="bg-white rounded-2xl p-6 w-full max-w-md relative">
        ...
        <div className="mb-6">
          ...
          <p className="mt-1 text-sm text-gray-500">
            Share the access code with your friends to let them join the group
          </p>
        </div>
        ...
        <div className="mb-6">
          ...
          <div className="flex items-center gap-2 bg-gray-50 border border-gray-200 rounded-lg p-3">
            <code className="flex-1 text-gray-900 font-mono">{accessCode}</code>
            <button
        ...
        <div className="space-y-3">
          <button
            ...
            className="w-full flex items-center gap-3 px-4 py-3 bg-[#25D366] text-white rounded-lg hover:bg-[#1ea952] transition-colors"
          >
        ...
        {/* Copied Toast */}
        {showCopiedToast && (
          <div className="fixed bottom-4 left-1/2 transform -translate-x-1/2 bg-gray-900 text-white px-4 py-2 rounded-lg text-sm font-medium">
