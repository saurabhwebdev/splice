    ...
    <div className="space-y-4">
      ...
      {group.participants.length > 0 ? (
                    ...
                    {!isSettled && (
                      <div className="relative settlement-tooltip">
                        ...
                        {activeSettlement === fullName && (
                          ...
                          >
                            <div 
                              className="bg-white rounded-xl shadow-xl p-4 max-w-xs w-full mx-4"
                              onClick={(e) => e.stopPropagation()}
                            >
                              <div className="flex items-center justify-between mb-3">
                                <h4 className="text-base font-semibold text-gray-900">Balance Details</h4>
                                <button
        ...
        <div className="text-center py-6">
          ...
          <button
            onClick={onAddParticipant}
            className="px-3 py-1.5 text-xs font-medium text-white bg-gray-900 rounded-lg hover:bg-gray-800 transition-colors inline-flex items-center gap-1.5"
          >
            <svg className="w-3.5 h-3.5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
              <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M12 4v16m8-8H4" />
            </svg>
